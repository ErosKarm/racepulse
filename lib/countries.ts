/**
 * Fetches the country using the nationality.
 * @param nationality (String) String Nationality
 * @returns (Object) Country Object
 */

export function countryFromNationality(nationality: string) {
  const matchedCountries = countries.filter((country) =>
    country.nationality.toLowerCase().includes(nationality.toLowerCase())
  );
  if (matchedCountries.length > 0) {
    if (nationality.toLowerCase() === "american") {
      return countries.filter(
        (country) => parseInt(country.num_code) == 840
      )[0];
    } else {
...
/**
 * Credit: https://github.com/Dinuks/country-nationality-list
 * Credit: https://github.com/yannickgloster/f1-lap-visualizer/blob/main/helpers/countries.js
 */
